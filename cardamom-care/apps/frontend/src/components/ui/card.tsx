...
export function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn(
        'rounded-xl border border-slate-800 bg-slate-900/60 dark:bg-slate-900/80 backdrop-blur text-slate-100 shadow-xl shadow-black/10 transition-all hover:border-slate-700/80',
        className
      )}
      {...props}
    />
